...
import com.umut.bilecikcitypromotion.Admin.Adapter.IlceAdapter
...
import com.umut.bilecikcitypromotion.databinding.FragmentAdminIlcelerBinding

class AdminIlceler : Fragment(), PopupMenu.OnMenuItemClickListener {
    private var _binding: FragmentAdminIlcelerBinding? = null
    private val binding get() = _binding!!
    private lateinit var popup : PopupMenu
    private lateinit var auth : FirebaseAuth
    private lateinit var db : FirebaseFirestore
    var adapter : IlceAdapter? = null
    val postList : ArrayList<Ilceler> = ArrayList()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdminIlcelerBinding.inflate(inflater, container, false)
        ...
        adapter = IlceAdapter(
            ...
            onDelete = { ilceId ->
                ...
                AlertDialog.Builder(requireContext())
                    ...
                    .setMessage("Bu ilçeyi silmek istediğinizden emin misiniz?")
                    .setPositiveButton("Evet") { _, _ ->
                        // Kullanıcı "Evet"e bastığında silme işlemi
                        db.collection("Ilceler").document(ilceId)
                            .delete()
                            .addOnSuccessListener {
                                Toast.makeText(requireContext(), "İlçe başarıyla silindi", Toast.LENGTH_SHORT).show()
            ...
            onEdit = { sehirId ->
                val intent = Intent(requireContext(), IlceDuzenleActivity::class.java)
                intent.putExtra("ilceId", sehirId) // Düzenlenecek şehir ID'sini gönder
    ...
    override fun onMenuItemClick(item: MenuItem?): Boolean {
        ...
        if (item?.itemId== R.id.SiteAnaSayfa){
            ...
            val intent = Intent(requireContext(), IlceYukleActivity::class.java)
            startActivity(intent)
