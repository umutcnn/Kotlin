...
import com.umut.bilecikcitypromotion.databinding.ActivityTarihiYerYuklemeBinding
import java.io.IOException
import java.util.UUID

class TarihiYerYuklemeActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTarihiYerYuklemeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTarihiYerYuklemeBinding.inflate(layoutInflater)
        ...
        if (selectedPicture != null) {
            try {
                ...
                val postMap = hashMapOf(
                    ...
                    "t_yer_adi" to binding.TarihiYerAdiText.text.toString(),
                    "k_aciklama" to binding.TarihiYerKisaAciklamaText.text.toString(),
                    "u_aciklama" to binding.TarihiYerUzunAciklamaText.text.toString(),
                    "date" to Timestamp.now()
                )

                db.collection("TarihiYerler").add(postMap)
                    .addOnSuccessListener {documentReference ->
                        val id = documentReference.id // Doküman ID'sini al
                        db.collection("TarihiYerler").document(id).update("id", id) // ID alanını Firestore'da güncelle
